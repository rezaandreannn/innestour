                    ...
                    <div class="card-body">
                        <form action="{{ route('role.store') }}" method="post">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input type="text" name="name" class="form-control"
                                        value="{{ old('name') }}" placeholder="Superadmin">
                                    @error('name')
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    {{-- textare --}}
                                    <textarea class="form-control" placeholder="Kelola semua fitur" id="deskripsi" name="deskripsi" style="height: 100px"></textarea>
                                    @error('deskripsi')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
